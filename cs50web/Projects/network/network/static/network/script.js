        ...
        .then(data => {
            data.all_posts.forEach(element => {
                ...
                if (element.likes.includes(username)) {
                    likes.innerHTML = `<span class='liked'><i data-id="${element.id}" class="fas like-b fa-heart"></i></span>&nbsp; ${element.likes.length}`;
                } else {
